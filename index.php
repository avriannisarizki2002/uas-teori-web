    ...
    <div id="container">
        <div id="header">
            <div class="headerBackground">
                <h1><span class="red-text">Nisabook</span> <span class="white-text">Store</span></h1>
            </div>
        </div>
            ...
            <div class="myCarousel">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <h1><b><font color="#f8192e">Nisabook</font>Store</b></h1>
                        <hr>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="background: black;">
            <nav class="footer">
                <footer class="copyright text-center"><p>&copy; Copyright Nisabook Store 2024</p></footer>
            </nav>
        </div>
    </div>
</body>
